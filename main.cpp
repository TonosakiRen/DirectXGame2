...
#pragma region DirectX初期化処理
	...
	//初期化の根本的な部分でエラーが出た場合はプログランぬが間違っているか、
...
#pragma region DirectX毎フレーム処理
			...
			//描画コマンド
			commandList->RSSetViewports(1, &viewport); //Viewportヲ設定
			...
			//Fenceの値を更新
			fenceValue++;
			//GPUがここまでたどり着いたときに,Fenceの値をしてした値に代入するようにSignalを送る
			commandQueue->Signal(fence, fenceValue);

			//Fenceの値がしてしたSignal値にたどり着いているのか確認する
